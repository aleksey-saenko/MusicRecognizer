...
Translations are managed via [Weblate](https://hosted.weblate.org/engage/audile/). You can register a new account or log in with your GitHub profile. Feel free to submit new translations, correct errors, or suggest better phrasing for existing strings. Please do not submit pull requests for translations directly to the repository.
