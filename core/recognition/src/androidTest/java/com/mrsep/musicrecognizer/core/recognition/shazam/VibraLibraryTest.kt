...
class VibraLibrary {
    ...
    fun rawPcmSampleTest(): Unit = runBlocking {
        ...
        controlTestSamples.forEach { (assetName, expHash, expSignature, sampleDuration, expTitle, expArtist) ->
            ...
            val signature = ShazamSignatureGeneratorVibra(context)
                .generate(sampleFile)
                .getOrThrow()
    ...
    companion object {
        ...
        private val controlTestSamples = listOf(
            LocalSample(
                ...
                signature = "data:audio/vnd.shazam.sig;base64,",
                duration = 5.seconds,
