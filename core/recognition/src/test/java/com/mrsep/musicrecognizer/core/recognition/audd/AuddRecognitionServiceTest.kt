...
import com.mrsep.musicrecognizer.core.recognition.emptyAudioRecordingFlow
import com.mrsep.musicrecognizer.core.recognition.infinityAudioRecordingFlow
import com.mrsep.musicrecognizer.core.recognition.normalAudioDelay1
import com.mrsep.musicrecognizer.core.recognition.normalAudioDelay2
import com.mrsep.musicrecognizer.core.recognition.normalAudioDelay3
import com.mrsep.musicrecognizer.core.recognition.normalAudioFlowDuration
import com.mrsep.musicrecognizer.core.recognition.normalAudioRecordingFlow
import com.mrsep.musicrecognizer.core.recognition.singleAudioRecordingFlow
...
class AuddRecognitionServiceTest {
    ...
    fun `NoMatches on single recording = NoMatches`() = scope.runTest {
        ...
        val result = service.recognizeUntilFirstMatch(
            singleAudioRecordingFlow(
